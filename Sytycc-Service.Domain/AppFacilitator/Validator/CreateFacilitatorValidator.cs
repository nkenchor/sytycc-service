...
public class CreateFacilitatorValidator : AbstractValidator<CreateFacilitatorDto>
{
    public CreateFacilitatorValidator()
    {
        ...
        public override ValidationResult Validate(ValidationContext<CreateFacilitatorDto> context)
    {
        return context.InstanceToValidate == null
            ? new ValidationResult(new[] { new ValidationFailure(nameof(CreateFacilitatorDto), 
