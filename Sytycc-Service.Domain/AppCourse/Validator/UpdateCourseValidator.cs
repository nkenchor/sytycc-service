...
// Utility functions for the validators
    private bool BeDateBefore(string startDate, string endDate)
    {
        ...
        bool isValidStart = DateTime.TryParseExact(startDate, "dd-MM-yyyy", CultureInfo.InvariantCulture, DateTimeStyles.None, out startDateTime);
        bool isValidEnd = DateTime.TryParseExact(endDate, "dd-MM-yyyy", CultureInfo.InvariantCulture, DateTimeStyles.None, out endDateTime);
    ...
    {
        DateTime startDateTime, endDateTime, startDateTimeTime, endDateTimeTime;

        bool isValidStartDate = DateTime.TryParseExact(startDate, "dd-MM-yyyy", CultureInfo.InvariantCulture, DateTimeStyles.None, out startDateTime);
        bool isValidEndDate = DateTime.TryParseExact(endDate, "dd-MM-yyyy", CultureInfo.InvariantCulture, DateTimeStyles.None, out endDateTime);
        bool isValidStartTime = DateTime.TryParseExact(startTime, "h:mm tt", CultureInfo.InvariantCulture, DateTimeStyles.None, out startDateTimeTime);
        bool isValidEndTime = DateTime.TryParseExact(endTime, "h:mm tt", CultureInfo.InvariantCulture, DateTimeStyles.None, out endDateTimeTime);
    ...
    {
        DateTime dateTime;
        bool isValid = DateTime.TryParseExact(date, "dd-MM-yyyy", CultureInfo.InvariantCulture, DateTimeStyles.None, out dateTime);
        ...
        public override ValidationResult Validate(ValidationContext<UpdateCourseDto> context)
    {
        return context.InstanceToValidate == null
            ? new ValidationResult(new[] { new ValidationFailure(nameof(UpdateCourseDto), 
